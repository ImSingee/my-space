...
declare const __SUBAPP_NAME__: string;
...
function About() {
  return (
    <div className="card">
      <h1>About</h1>
      <p className="muted">
        This subapp was scaffolded by Hatch. It has a React SPA (hash routing),
        a Deno Connect backend, and its own Postgres database.
      </p>
    </div>
  );
}
